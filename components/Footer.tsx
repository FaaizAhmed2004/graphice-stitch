        ...
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="bg-green-500 text-white font-bold px-8 py-3 rounded-full hover:scale-105 transition-transform shadow-lg flex items-center gap-2"
            >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="w-8 h-8 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200">
              ...
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="w-8 h-8 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200">
              ...
              {/* YouTube */}
              <a href="#" aria-label="YouTube" className="w-8 h-8 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-500 hover:text-purple-400 transition-colors flex items-center gap-1.5 group"
                  >
              ...
              {[
                ...
                <li key={s.label}>
                  <Link
                    ...
                    className="text-sm text-gray-500 hover:text-purple-400 transition-colors flex items-center gap-1.5 group"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-pink-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                    {s.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-4">
              <li>
                <a href={`mailto:${CONTACT_EMAIL}`} className="flex items-start gap-3 group">
                  ...
                  <span className="text-sm text-gray-500 group-hover:text-purple-400 transition-colors break-all">{CONTACT_EMAIL}</span>
                </a>
              </li>
              <li>
                <a href={`tel:${CONTACT_PHONE}`} className="flex items-start gap-3 group">
                  ...
                  <span className="text-sm text-gray-500 group-hover:text-purple-400 transition-colors">{CONTACT_PHONE}</span>
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-green-600/20 hover:bg-green-600/30 border border-green-600/30 text-green-400 text-sm px-3 py-2 rounded-lg transition-colors"
                >
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-4">
            <Link href="/privacy" className="text-xs text-gray-600 hover:text-purple-400 transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-xs text-gray-600 hover:text-purple-400 transition-colors">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
