  ...
  return (
    <main className="min-h-screen bg-[#f3f2ee] text-[#171717]">
      ...
      <div className="mx-auto max-w-7xl px-5 py-8 lg:px-8 lg:py-12">
        ...
        <section className="mt-12"><div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-black/40">Client work</p><h2 className="mt-2 text-3xl font-black tracking-tight">Your projects</h2></div><Link href="/quote" className="inline-flex items-center gap-2 rounded-full border border-black/15 bg-white px-4 py-2.5 text-sm font-bold transition hover:border-black/40">New project <ArrowUpRight className="h-4 w-4" /></Link></div>
